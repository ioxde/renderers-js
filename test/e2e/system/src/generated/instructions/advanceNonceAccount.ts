...
>(
    ...
    if (!containsBytes(instruction.data, getU32Encoder().encode(ADVANCE_NONCE_ACCOUNT_DISCRIMINATOR), 0)) {
        const error = new Error(
            `parseAdvanceNonceAccountInstruction: instruction data does not match the AdvanceNonceAccount discriminator`,
        );
