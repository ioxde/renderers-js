...
export const MIGRATE_TO_CPSWAP_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
    136, 92, 200, 103, 28, 218, 144, 140,
]);

export function getMigrateToCpswapDiscriminatorBytes(): ReadonlyUint8Array {
...
> = Instruction<TProgram> &
    ...
    InstructionWithAccounts<
        [
            ...
            TAccountCpswapProgram extends string ? ReadonlyAccount<TAccountCpswapProgram> : TAccountCpswapProgram,
            TAccountCpswapPool extends string ? WritableAccount<TAccountCpswapPool> : TAccountCpswapPool,
            TAccountCpswapAuthority extends string ? ReadonlyAccount<TAccountCpswapAuthority> : TAccountCpswapAuthority,
            TAccountCpswapLpMint extends string ? WritableAccount<TAccountCpswapLpMint> : TAccountCpswapLpMint,
            TAccountCpswapBaseVault extends string ? WritableAccount<TAccountCpswapBaseVault> : TAccountCpswapBaseVault,
            TAccountCpswapQuoteVault extends string
                ? WritableAccount<TAccountCpswapQuoteVault>
                : TAccountCpswapQuoteVault,
            TAccountCpswapConfig extends string ? ReadonlyAccount<TAccountCpswapConfig> : TAccountCpswapConfig,
            ...
            TAccountLockProgram extends string ? ReadonlyAccount<TAccountLockProgram> : TAccountLockProgram,
            TAccountLockAuthority extends string ? ReadonlyAccount<TAccountLockAuthority> : TAccountLockAuthority,
            TAccountLockLpVault extends string ? WritableAccount<TAccountLockLpVault> : TAccountLockLpVault,
...
export type MigrateToCpswapInstructionData = { discriminator: ReadonlyUint8Array };
...
export function getMigrateToCpswapInstructionDataEncoder(): FixedSizeEncoder<MigrateToCpswapInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]), value => ({
        ...value,
        discriminator: MIGRATE_TO_CPSWAP_DISCRIMINATOR,
    }));
}
...
> {
    return combineCodec(getMigrateToCpswapInstructionDataEncoder(), getMigrateToCpswapInstructionDataDecoder());
}
...
> {
    ...
    return Object.freeze({
        accounts: [
            ...
            getAccountMeta('cpswapProgram', accounts.cpswapProgram),
            getAccountMeta('cpswapPool', accounts.cpswapPool),
            getAccountMeta('cpswapAuthority', accounts.cpswapAuthority),
            getAccountMeta('cpswapLpMint', accounts.cpswapLpMint),
            getAccountMeta('cpswapBaseVault', accounts.cpswapBaseVault),
            getAccountMeta('cpswapQuoteVault', accounts.cpswapQuoteVault),
            getAccountMeta('cpswapConfig', accounts.cpswapConfig),
            getAccountMeta('cpswapCreatePoolFee', accounts.cpswapCreatePoolFee),
            getAccountMeta('cpswapObservation', accounts.cpswapObservation),
            getAccountMeta('lockProgram', accounts.lockProgram),
            getAccountMeta('lockAuthority', accounts.lockAuthority),
            getAccountMeta('lockLpVault', accounts.lockLpVault),
...
export function parseMigrateToCpswapInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
