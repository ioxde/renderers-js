...
export const BUY_EXACT_IN_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([250, 234, 13, 123, 213, 156, 19, 236]);
...
export function parseBuyExactInInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
