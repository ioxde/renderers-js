...
export const BUY_EXACT_OUT_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([24, 211, 116, 40, 105, 3, 153, 56]);
...
> {
    return combineCodec(getBuyExactOutInstructionDataEncoder(), getBuyExactOutInstructionDataDecoder());
}
...
export function parseBuyExactOutInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
