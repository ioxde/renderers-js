...
export type AmmLpMintSeeds = {
    market: Address;
};

export async function findAmmLpMintPda(seeds: AmmLpMintSeeds): Promise<ProgramDerivedAddress> {
    return await getProgramDerivedAddress({
        ...
        seeds: [
            ...
            getBytesEncoder().encode(
                new Uint8Array([
                    108, 112, 95, 109, 105, 110, 116, 95, 97, 115, 115, 111, 99, 105, 97, 116, 101, 100, 95, 115, 101,
                    101, 100,
                ]),
            ),
        ],
