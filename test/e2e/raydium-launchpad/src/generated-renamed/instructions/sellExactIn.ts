...
export const SELL_EXACT_IN_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([149, 39, 222, 155, 211, 124, 152, 26]);
...
> {
    return combineCodec(getSellExactInInstructionDataEncoder(), getSellExactInInstructionDataDecoder());
}
...
export function parseSellExactInInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
