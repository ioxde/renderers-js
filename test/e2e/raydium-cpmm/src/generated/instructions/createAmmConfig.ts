...
import { findAmmConfigPda } from '../pdas/index.js';
...
export function parseCreateAmmConfigInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
    ...
    if (!containsBytes(instruction.data, CREATE_AMM_CONFIG_DISCRIMINATOR, 0)) {
        const error = new Error(
            `parseCreateAmmConfigInstruction: instruction data does not match the CreateAmmConfig discriminator`,
        );
