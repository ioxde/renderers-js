...
export function parseUpdatePoolStatusInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
    ...
    if (!containsBytes(instruction.data, UPDATE_POOL_STATUS_DISCRIMINATOR, 0)) {
        const error = new Error(
            `parseUpdatePoolStatusInstruction: instruction data does not match the UpdatePoolStatus discriminator`,
        );
