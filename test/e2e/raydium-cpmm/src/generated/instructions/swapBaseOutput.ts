...
export function parseSwapBaseOutputInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
    ...
    if (!containsBytes(instruction.data, SWAP_BASE_OUTPUT_DISCRIMINATOR, 0)) {
        const error = new Error(
            `parseSwapBaseOutputInstruction: instruction data does not match the SwapBaseOutput discriminator`,
        );
