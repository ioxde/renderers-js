...
export function parseBurnCheckedInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
    ...
    if (!containsBytes(instruction.data, getU8Encoder().encode(BURN_CHECKED_DISCRIMINATOR), 0)) {
        const error = new Error(
            `parseBurnCheckedInstruction: instruction data does not match the BurnChecked discriminator`,
        );
