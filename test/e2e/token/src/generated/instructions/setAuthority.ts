...
export function parseSetAuthorityInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
    ...
    if (!containsBytes(instruction.data, getU8Encoder().encode(SET_AUTHORITY_DISCRIMINATOR), 0)) {
        const error = new Error(
            `parseSetAuthorityInstruction: instruction data does not match the SetAuthority discriminator`,
        );
