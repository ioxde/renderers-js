...
export function parseCloseAccountInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
    ...
    if (!containsBytes(instruction.data, getU8Encoder().encode(CLOSE_ACCOUNT_DISCRIMINATOR), 0)) {
        const error = new Error(
            `parseCloseAccountInstruction: instruction data does not match the CloseAccount discriminator`,
        );
