...
export function parseMintToCheckedInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
    ...
    if (!containsBytes(instruction.data, getU8Encoder().encode(MINT_TO_CHECKED_DISCRIMINATOR), 0)) {
        const error = new Error(
            `parseMintToCheckedInstruction: instruction data does not match the MintToChecked discriminator`,
        );
