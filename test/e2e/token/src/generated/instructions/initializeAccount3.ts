...
>(
    ...
    if (!containsBytes(instruction.data, getU8Encoder().encode(INITIALIZE_ACCOUNT3_DISCRIMINATOR), 0)) {
        const error = new Error(
            `parseInitializeAccount3Instruction: instruction data does not match the InitializeAccount3 discriminator`,
        );
