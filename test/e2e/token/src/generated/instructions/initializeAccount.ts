...
>(
    ...
    if (!containsBytes(instruction.data, getU8Encoder().encode(INITIALIZE_ACCOUNT_DISCRIMINATOR), 0)) {
        const error = new Error(
            `parseInitializeAccountInstruction: instruction data does not match the InitializeAccount discriminator`,
        );
