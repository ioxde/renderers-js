...
export function parseSyncNativeInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
    ...
    if (!containsBytes(instruction.data, getU8Encoder().encode(SYNC_NATIVE_DISCRIMINATOR), 0)) {
        const error = new Error(
            `parseSyncNativeInstruction: instruction data does not match the SyncNative discriminator`,
        );
