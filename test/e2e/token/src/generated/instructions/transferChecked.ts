...
export function parseTransferCheckedInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
    ...
    if (!containsBytes(instruction.data, getU8Encoder().encode(TRANSFER_CHECKED_DISCRIMINATOR), 0)) {
        const error = new Error(
            `parseTransferCheckedInstruction: instruction data does not match the TransferChecked discriminator`,
        );
