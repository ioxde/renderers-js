...
>(
    ...
    if (!containsBytes(instruction.data, getU8Encoder().encode(INITIALIZE_ACCOUNT2_DISCRIMINATOR), 0)) {
        const error = new Error(
            `parseInitializeAccount2Instruction: instruction data does not match the InitializeAccount2 discriminator`,
        );
